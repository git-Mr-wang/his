...
public class GenerateCode2 {
    ...
    private static String tableName = "doctor_menu";
    private static String tableChineseName = "套餐管理";
    ...
    private static void generateMapper(ResultSetMetaData metaData,String javaBeanName, BufferedWriter mapperWriter, String now) throws IOException, SQLException {
        ...
        mapperWriter.write("\t\twhere "+primarykey+" = #{"+priName+",jdbcType=INTEGER} \r\n");
        mapperWriter.write("\t</select> \r\n");
        ...
        for(int i=2;i<=count;i++) {
            ...
            insertValueBuffer.append("#{"+javaCol+",jdbcType="+type+"},");
        }
        ...
        for(int i=2;i<=count;i++) {
            ...
            mapperWriter.write("\t\t\t<if test=\""+javaCol+" != null\" > \r\n");
            mapperWriter.write("\t\t\t\t"+columnName+" = #{"+javaCol+",jdbcType="+type+"}, \r\n");
        ...
        for(int i=2;i<=count;i++) {
            ...
            updateBuffer.append(" "+columnName+" = #{"+javaCol+",jdbcType="+type+"},");
        }
        ...
        for(int i=2;i<=count;i++) {
            ...
            mapperWriter.write("\t\t<include refid=\"Base_Column_List\" /> \r\n");
            mapperWriter.write("\t\tfrom "+tableName+" \r\n");
            mapperWriter.write("\t\twhere "+columnName+" = #{"+javaCol+",jdbcType="+type+"} \r\n");
            mapperWriter.write("\t</select> \r\n");
